...
return i.add({start:n.start,end:n.start+r,length:r,substr:o}),i}}const x=e=>{void 0===p&&(p=w(u)),e=y(e)
let t="",i=[new I]
...
let e=new I
const s=i[0]
s&&e.add(s.last()),i=[e]}}return t+=C(i,!0),t},A=(e,t)=>{if(e)return e[t]},k=(e,t)=>{if(e){for(var i,s=t.split(".");(i=s.shift())&&(e=e[i]););return e}},F=(e,t,i)=>{var s,n
...
const e=[]
s.fields.forEach((t=>{"string"==typeof t&&(t={field:t,weight:1}),e.push(t),i[t.field]="weight"in t?t.weight:1})),s.fields=e}return{options:s,query:e.toLowerCase().trim(),tokens:this.tokenize(e,s.respect_word_boundaries,i),total:0,items:[],weights:i,getAttrFn:s.nesting?k:A}}search(e,t){var i,s,n=this
...
return N(e,(e=>{"string"==typeof e&&(e=e.trim().split(/[\x11\x12\x14\x15\x40]/)),Array.isArray(e)&&(t=t.concat(e))})),t.filter(Boolean)},M=e=>(Array.isArray(e)||(e=[e]),e),z=(e,t,i)=>{if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
