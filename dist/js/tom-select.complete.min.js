...
return N(e,(e=>{"string"==typeof e&&(e=e.trim().split(/[\x09\x0a\x0c\x0d\x20]/)),Array.isArray(e)&&(t=t.concat(e))})),t.filter(Boolean)},M=e=>(Array.isArray(e)||(e=[e]),e),z=(e,t,i)=>{if(!i||i.contains(e))for(;e&&e.matches;){if(e.matches(t))return e
