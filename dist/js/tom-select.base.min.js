...
let t=new A
const s=i[0]
s&&t.add(s.last()),i=[t]}}return e+=S(i,!0),e},x=(t,e)=>{if(t)return t[e]},F=(t,e)=>{if(t){for(var i,s=e.split(".");(i=s.shift())&&(t=t[i]););return t}},L=(t,e,i)=>{var s,n
...
return $(t,(t=>{"string"==typeof t&&(t=t.trim().split(/[\x11\x12\x14\x15\x40]/)),Array.isArray(t)&&(e=e.concat(t))})),e.filter(Boolean)},M=t=>(Array.isArray(t)||(t=[t]),t),z=(t,e,i)=>{if(!i||i.contains(t))for(;t&&t.matches;){if(t.matches(e))return t
